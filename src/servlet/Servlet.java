...
import classes.activator.Monitor;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("loginButton") != null) {
           TransmittedUserParams transmittedUserParams = TransmittedUserParams.create()
            ...
            Monitor m=(Monitor)request.getAttribute("tr");
            System.out.println(m==null);
        // TransmittedUserParams transmittedUserParams1=(TransmittedUserParams)request.getSession(true).getAttribute("tr");
        //    System.out.println((transmittedUserParams1==null)+" "+(controller==null));
        //    System.out.println(transmittedUserParams1.getLogin());
     ...
     //       request.setAttribute("log",userResponse);
        ...
        if(request.getParameter("lalaButton")!=null){
            List<Integer> list=new ArrayList<Integer>();
            for(int i=0;i<10;i++){
                list.add(i);
            }
            request.setAttribute("list",list);
            request.getRequestDispatcher("lalala.jsp").forward(request, response);
